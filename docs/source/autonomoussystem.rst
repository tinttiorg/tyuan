...
Autonomous driving poses unique challenges for complicated vehicle environments, attracting distinguished teams and researchers to employ state-of-the-art technologies, such as deep learning, sensor fusion, extended object tracking, and high resolution sensor systems, taking the jewel in the crown of the AI/automotive industry.
...
However, the divided components are not really decoupled, results in extreme complex and bulky autonomous driving systems.
...
Based on our deep domain knowledge and long-term experience in the AD society, we have expected that a possible history of AD systems could be more or less like the one shown in Fig.02.
...
.. admonition:: Computational Capability and Units 
    ...
    Xilinx tries to solve the issue from
